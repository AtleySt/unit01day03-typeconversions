class DoubleOps {
    public static void main(String[] args) {
        ...
        // TODO: introduce variables here so you don't need to parse so many times
        ...
        // double pow
        System.out.println(args[0] + " to the power of " + args[1] + " is "
                + Math.pow(Double.parseDouble(args[0]), Double.parseDouble(args[1])));
